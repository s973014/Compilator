...
![image](https://github.com/user-attachments/assets/73a60272-4682-4dce-8897-4bbc341982d4)
![image](https://github.com/user-attachments/assets/6defeca0-5f63-4229-99f2-72d8bbf19f8d)
![image](https://github.com/user-attachments/assets/5d42a6ff-224d-4301-9d21-ab721622a7d9)

## Дополнительное задание
Задание:<br>
1. Реализовать для своего варианта задания в данной лабораторной работе алгоритм лексического анализа (лексемная декомпозиция и поиск лексических ошибок).<br>
2. Дополните README-файл диаграммой сканера и тестовыми примерами (скриншотами работы программы).<br>
